 ...
 <div x-data="{ open: true }" >
        <aside
            ...
            class="h-[1000px] absolute top-[80px] left-0 bg-[#033372] text-white font-['Poppins'] transition-all duration-300">
...
<div class="relative group">
    <a href="{{ route('deliveries.index') }}"
       class="flex items-center gap-5 px-5 py-3 text-[14px] transition-all duration-300 
           hover:bg-white hover:text-[#033372] hover:rounded-xl
           {{ request()->routeIs('deliveries') ? 'bg-white text-[#033372] rounded-xl' : '' }}">
