               ...
               <!-- Email Address -->
                ...
                <div class="relative w-full">
                   ...
                   <input type="text" id="email" name="email" required
                    ...
                    text-gray-600 text-[10px] font-medium font-['Poppins'] leading-normal focus:ring-1 focus:ring-[#2D9CDB] focus:border-[#2D9CDB]
            ...
            <a href="{{ route('password.request') }}"
                ...
                <div class="w-80 left-[33px] top-[415px] absolute inline-flex flex-col justify-start items-start gap-5 mt-5">
                    <button type="submit" id="loginBtn"
                        class="self-stretch h-9 bg-[#2D9CDB] text-white text-base font-medium font-['Poppins'] rounded-lg flex justify-center items-center hover:bg-[#238ACB] transition disabled:opacity-50 disabled:cursor-not-allowed">
                        Log in
                    </button>
