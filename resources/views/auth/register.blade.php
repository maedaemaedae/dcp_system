            ...
            <div class="w-[413px] h-full rounded-lg bg-white px-10 py-6 flex flex-col justify-between overflow-y-auto"> <!-- Adjusted padding and added overflow -->
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        ...
                        <!-- Checklist -->
                        <ul class="text-xs text-gray-600 mt-2 space-y-1" id="passwordChecklist">
                            <li id="lengthCheck" class="flex items-center gap-1"><span>🔴</span> At least 8 characters</li>
                            <li id="lowercaseCheck" class="flex items-center gap-1"><span>🔴</span> Contains lowercase letter</li>
                            <li id="uppercaseCheck" class="flex items-center gap-1"><span>🔴</span> Contains uppercase letter</li>
                            <li id="numberCheck" class="flex items-center gap-1"><span>🔴</span> Contains a number</li>
                            <li id="symbolCheck" class="flex items-center gap-1"><span>🔴</span> Contains a symbol (!@#$%)</li>
                        </ul>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function togglePassword() {
        ...
        if (passwordField.type === 'password') {
            ...
            eyeIcon.innerHTML = `
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.038 10.038 0 012.65-4.043m3.6-2.161A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.965 9.965 0 01-4.293 5.148M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M3 3l18 18" />
            `;
        } else {
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
        if (password.value !== confirmPassword.value) {
            ...
            confirmPassword.focus();
                    ...
                    <button type="submit" id="submit-btn" class="mt-4 w-full h-10 border-2 border-[#2D9CDB] text-[#2D9CDB] text-base font-medium rounded-full hover:bg-[#2D9CDB] hover:text-white transition disabled:bg-gray-400 disabled:cursor-not-allowed">
                        Create an account
                    </button>
