<div id="createRegionalModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        ...
        <form method="POST" action="{{ route('regional-offices.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="ro_id" class="w-full border rounded px-3 py-2" required>
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="ro_address" class="w-full border rounded px-3 py-2">
                </div>
                <div>
