        ...
        <form id="editRecipientForm" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="col-span-1 md:col-span-2">
                    <label for="edit_notes" class="block font-medium text-sm text-gray-700">Notes</label>
                    <textarea name="notes" id="edit_notes" rows="3" class="w-full border-gray-300 rounded"></textarea>
                </div>
            </div>
