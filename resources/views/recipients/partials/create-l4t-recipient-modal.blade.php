<div id="createL4tRecipientModal" class="fixed inset-0 hidden justify-center items-center bg-gray-900 bg-opacity-50 z-50">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
    ...
    <form action="{{ route('recipients.l4t.store') }}" method="POST">
      ...
      <div class="flex justify-end gap-2">
        ...
        <button type="button" onclick="closeModal('createL4tRecipientModal')" class="px-4 py-2 border rounded">Cancel</button>
      </div>
    </form>
  </div>
</div>
