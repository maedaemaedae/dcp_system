...
<html lang="en">
<head>
    <title>Laptops | DCP Tracking Hub</title>
...
<div class="min-h-screen relative">
    ...
    <div class="relative px-6 py-8 max-w-8xl mx-auto">
        ...
        <h1 class="text-3xl md:text-4xl font-bold mt-48 mb-16 flex items-center gap-3">
            <i class="fa-solid fa-laptop text-indigo-500 text-2xl"></i> Laptops
        </h1>
        <div class="bg-white shadow-md rounded-xl p-6 mb-8 border border-gray-100 flex flex-wrap gap-4 items-center justify-between">
            <div class="flex items-center gap-2 px-4 py-2 border border-indigo-500 text-indigo-500 rounded-lg bg-white">
                <span class="fa-solid fa-laptop"></span>
                <span class="font-semibold">Total Laptops:</span>
                <span class="text-2xl font-bold">{{ $laptops->count() }}</span>
            </div>
        </div>
