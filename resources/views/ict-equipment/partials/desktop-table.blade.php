    ...
    <table class="min-w-full text-sm border border-gray-300">
        <thead class="bg-[#4A90E2] text-white sticky top-0">
            <tr>
                ...
                <th class="p-3 text-left">PC Make</th>
                <th class="p-3 text-left">PC Model</th>
                ...
                <th class="p-3 text-left">Keyboard SN</th>
        ...
        <tbody class="divide-y divide-gray-100">
            @forelse ($desktops as $desktop)
                <tr class="hover:bg-blue-50 transition-colors duration-200">
                    ...
                    <td class="p-2 border">{{ $desktop->condition }}</td>
                    ...
                    <button class="text-green-600 hover:text-green-800" 
                        ...
                        <form action="{{ route('ict-equipment.destroy', ['category' => 'desktop', 'id' => $desktop->id]) }}" 
                            method="POST" 
