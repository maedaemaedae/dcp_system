...
<body class="bg-gray-50 font-['Poppins'] text-gray-800">
    <div class="max-w-6xl mx-auto py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-10">
            ...
            <a href="{{ route('ict-equipment.in-use') }}" class="bg-white rounded-xl shadow p-6 flex flex-col items-center hover:bg-green-50 transition cursor-pointer">
            ...
            <a href="{{ route('ict-equipment.for-repair') }}" class="bg-white rounded-xl shadow p-6 flex flex-col items-center hover:bg-yellow-50 transition cursor-pointer">
            ...
            <a href="{{ route('ict-equipment.laptops') }}" class="bg-white rounded-xl shadow p-6 flex flex-col items-center hover:bg-indigo-50 transition cursor-pointer">
            ...
            <a href="{{ route('ict-equipment.printers') }}" class="bg-white rounded-xl shadow p-6 flex flex-col items-center hover:bg-pink-50 transition cursor-pointer">
            ...
            <a href="{{ route('ict-equipment.desktops') }}" class="bg-white rounded-xl shadow p-6 flex flex-col items-center hover:bg-purple-50 transition cursor-pointer">
