<h3 class="text-lg font-bold mb-4 flex items-center gap-2 text-[#1F2937]">
    ...
    <div class="overflow-visible rounded-2xl border">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                >
                                    ...
                                    <div 
                                        ...
                                        class="absolute right-0 z-30 w-36 bg-white rounded-xl shadow-xl border border-gray-200 py-1 text-sm"
                                        style="display: none;"
                                    ...
                                    >
                                        ...
                                        <button
                                            @click="
                                                ...
                                                open = false"
                                            class="flex items-center gap-2 w-full px-4 py-2 text-blue-600 hover:bg-gray-100 transition"
                                        >
