...
<head>
    <meta charset="UTF-8">
    <title>Projects | DCP Tracking Hub</title>
...
@endif
  ...
  <main  :class="open ? 'ml-[5px]' : 'ml-5'" class="transition-all duration-300 p-8 pb-20 relative flex-1 overflow-y-auto h-[calc(100vh-5rem)]" x-show="contentVisible" x-transition.opacity.duration.500ms x-cloak>
