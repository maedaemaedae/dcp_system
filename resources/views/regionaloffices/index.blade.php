            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left">RO ID</th>
                        <th class="px-4 py-2 text-left">RO Office</th>
                        <th class="px-4 py-2 text-left">RO Address</th>
                ...
                <tbody>
                    @forelse ($regionalOffices as $ro)
                        <tr class="border-b">
                            <td class="px-4 py-2">Region {{ $ro->ro_id }}</td>
                            <td class="px-4 py-2">{{ $ro->ro_id }}</td>
                            <td class="px-4 py-2">{{ $ro->ro_office }}</td>
                            <td class="px-4 py-2">{{ $ro->ro_address ?? '—' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-gray-500 py-4">No regional offices found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
